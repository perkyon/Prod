...
export function FloatingSocial() {
  const socialLinks = [
    { 
      icon: Instagram, 
      url: "https://instagram.com/buro.workshop",
      label: "Instagram"
    },
    { 
      icon: MessageCircle, 
      url: "https://t.me/buro_workshop",
      label: "Telegram"
    },
    { 
      icon: Send, 
      url: "https://wa.me/79952025404",
      label: "WhatsApp"
    },
    {
      icon: () => (
    ...
    },
    {
      ...
      url: "https://pinterest.com/buroworkshop",
      label: "Pinterest"
    }
  ];
      ...
      <div className="flex flex-row gap-3">
        {socialLinks.map((social, index) => (
          <a
            ...
            className="w-10 h-10 bg-black text-white rounded-full flex items-center justify-center hover:bg-gray-800 hover:scale-110 transition-all duration-200 shadow-lg"
            title={social.label}
          >
